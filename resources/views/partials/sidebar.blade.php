<aside class="sidebar sidebar-default sidebar-dark navs-pill">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../dashboard/index.html" class="navbar-brand">
                <img src="{{asset('assets/images/logo.png')}}" width="60" style="border-radius: 30px;"/>
                <!--Logo start-->
                ...
                <!--logo End-->            <h4 class="logo-title" style="margin-top: 15px;">{{ config('app.name', 'Graffiti') }}</h4>
            </a>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#settings" role="button" aria-expanded="false" aria-controls="horizontal-menu">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse" id="settings" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="../dashboard/index-dual-compact.html">
                                    ...
                                    <i class="sidenav-mini-icon"> D </i>                   
                                    <span class="item-name">Cash Flow</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                                <a class="nav-link " href="#">
                                    ...
                                    <span class="item-name">System Users</span>
                                </a>
                            </li>  
                            <li class="nav-item">
                                <a class="nav-link " href="#">
                                    ...
                                    <i class="sidenav-mini-icon"> U </i>
                                    <span class="item-name">Office Users</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="#">
