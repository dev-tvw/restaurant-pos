                     ...
                     <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" data-toggle="validator">
                           ...
                           <div class="row">
                              <div class="col-lg-10">
                                 <div class="form-group">
                                    ...
                                    <input style="border: 2px solid orange;" id="email" type="email" name="email"  value="{{env('IS_DEMO') ? 'admin@example.com' : old('email')}}"   class="form-control"  placeholder="Email" required autofocus>
                                 </div>
                              </div>
                              <div class="col-lg-10">
                                 <div class="form-group">
                                    <!-- <label for="password" class="form-label">Password</label> -->
                                    <input style="border: 2px solid orange;" class="form-control" type="password" placeholder="Password"  name="password" value="{{ env('IS_DEMO') ? 'password' : '' }}" required autocomplete="current-password">
                                 </div>
                              </div>
                             {{-- <div class="col-lg-6">
                           ...
                           <div class="d-flex justify-content-center col-lg-10 mt-4">
                              <button type="submit" class="btn btn-warning">{{ __('Sign In') }}</button>
                           </div>
