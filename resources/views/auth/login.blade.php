                           ...
                           <div class="row">
                              <div class="col-lg-10">
                                 <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="email" name="email" value="{{env('IS_DEMO') ? 'admin@example.com' : old('email')}}" class="form-control input-class" placeholder="Email" required autofocus>
                                 </div>
                              </div>
                              <div class="col-lg-10">
                                 <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><i class="fa fa-lock"></i></span>
                                    <input class="form-control input-class" type="password" placeholder="Password" name="password" value="{{ env('IS_DEMO') ? 'password' : '' }}" required autocomplete="current-password">
                                 </div>
                              </div>
                              {{-- <div class="col-lg-6">
