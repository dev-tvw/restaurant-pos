                                ...
                                <div class="col-lg-12">
                                    <div class=" col-lg-12">
                                        <div class="row">
                                            ...
                                            <hr class="row brc-default-l1 mx-n1 mb-4" />
                                            {{-- <span style="font-weight: 800;color:black;font-size: 40px;text-align: center">Welcome</span><br> --}}
                                            <span style="font-weight: 800;color:black;font-size: 50px;text-align: center;margin-left: 35%;">Order #{{$order->daily_code}}</span><br>
                                            <span style="font-weight: 800;color:black;text-align: center;font-size: 30px;margin-left: 23%;">Date & Time : {{dateFormat($order->created_at)}}</span><br>
                                            <span style="font-weight: 800;color:black;text-align: center;font-size: 30px;margin-left: 23%;">Customer Name :  {{  $order->customer->name }}</span><br>
                                    ...
                                    <div class="mt-4">
                                        <div class="row text-600 text-white bgc-default-tp1 py-25">
                                            <div class="d-none d-sm-block col-1" style="font-weight: 700;color:black;font-size: x-large;">#</div>
                                            <div class="col-9 col-sm-5" style="font-weight: 700;color:black;font-size: x-large;">Description</div>
                                            <div class="d-none d-sm-block col-4 col-sm-2" style="font-weight: 700;color:black;font-size: x-large;">Qty</div>
                                            <div class="d-none d-sm-block col-sm-2" style="font-weight: 700;color:black;font-size: x-large;">Unit Price</div>
